...
long long simulateBeam(std::vector<std::string> contraption){
...
int main() {
    ...
    long long energizedTiles = simulateBeam(contraption);

    std::cout << "Energized Tiles: " << energizedTiles << std::endl;
}